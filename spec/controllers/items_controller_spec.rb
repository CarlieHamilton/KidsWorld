...
RSpec.describe ItemsController, type: :controller do
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
    {seller_id: User.first.id, title: "hello", description: "description", condition: :used, category: :toys, sold: false, price: 2.20}
      }
      ...
      it "updates the requested item" do
        ...
        item.reload
        expect(item.title).to eq(new_attributes[:title])
      end
